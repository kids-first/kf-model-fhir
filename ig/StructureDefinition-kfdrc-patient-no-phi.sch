...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile kfdrc-patient
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.kids-first.io/StructureDefinition/species']) &lt;= 1">extension with URL = 'http://fhir.kids-first.io/StructureDefinition/species': maximum cardinality of 'extension' is 1</sch:assert>
